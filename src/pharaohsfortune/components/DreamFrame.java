...
import pharaohsfortune.util.VisualTools;
...
public class DreamFrame extends JFrame {
    ...
    public DreamFrame(String title, BufferedImage logo) {
        ...
        getContentPane().setBackground(UIColors.BODY_COLOUR);
    ...
    private class DreamHeader extends DreamPanel {
        ...
        DreamHeader(JFrame frame, String title, BufferedImage img) {
            ...
            right.add(minBtn = new DreamButton("Start", UIColors.BUTTON_COLOUR, UIColors.TEXT_COLOR));
            right.add(closeBtn = new DreamButton("Exit", UIColors.BUTTON_COLOUR, UIColors.TEXT_COLOR));
